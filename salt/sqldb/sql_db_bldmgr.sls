...
mysql_bldmgr_db_table:
  module.run:
    ...
    - query: 'CREATE TABLE IF NOT EXISTS {{ sql_bldmgr_db_table }} ( build_end DATETIME, build_start TIMESTAMP DEFAULT CURRENT_TIMESTAMP, OS VARCHAR(10) NOT NULL, Version VARCHAR(10) NOT NULL, Platform VARCHAR(10) NOT NULL, Status VARCHAR(10) NOT NULL DEFAULT "ERRORS", build_log VARCHAR(255) NOT NULL, build_product VARCHAR(255) NOT NULL, idkey BIGINT NOT NULL) DEFAULT CHARSET=utf8'
    - require:
