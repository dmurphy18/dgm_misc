...
Patch2: %{name}-%{version}-salt.patch
...
%changelog
* Mon Dec 14 2015 SaltStack Packaging Team <packaging@saltstack.com> - 2.7.5-3
- Altered ctypes/util.py find_library to function on AIX for Salt
