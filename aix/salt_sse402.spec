...
%files
%defattr(-,root,root,-)
## DGM LICENSE  removed with 3.2.0-5
## %doc $RPM_BUILD_DIR/%{name}-%{version}/%{srcname}-%{version}/LICENSE
%{python_sitelib}/%{srcname}/*
%{python_sitelib}/%{srcname}-4.?.?-py?.?.egg-info
...
%changelog
* Wed Jun 05 2015 David Murphy <dmurphy@saltstack.com>  4.0.2-1
- SSE Enterprise for AIX, updated release

* Mon May 18 2015 David Murphy <dmurphy@saltstack.com>  3.2.0-5
- SSE Enterprize for AIX, fork from Kistian Berg and SSE 3.2 rpm spec
